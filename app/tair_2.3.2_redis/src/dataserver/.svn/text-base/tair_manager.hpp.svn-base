...
#define METHOD_HVALS    2
   ...
   public:
      ...
      int clear (int area);
      int lazyclear(int area, const char* password, const int password_len);
      ...
      int setnsattr(int area, const char* attr, const int attr_len, const char* val, const int val_len);
      int getnsattr(int area, const char* attr, const int attr_len, char** val, int* val_len);
