...
class storage_manager  {
    public:
        ...
        virtual int lazyclear(int area, const char* password, const int pwd_len)
        {
            return TAIR_RETURN_IS_NOT_IMPLEMENT;
        }
        ...
        virtual int setnsattr(int area, const char* attr, const int attr_len,
                const char* val, const int val_len)
        {
            return TAIR_RETURN_IS_NOT_IMPLEMENT;
        }

        virtual int getnsattr(int area, const char* attr, const int attr_len,
