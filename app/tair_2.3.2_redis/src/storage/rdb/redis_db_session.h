...
public:
    ...
    int persist(MKEY);
    int exists(MKEY);
    int setdbattr(uint32_t area, const char* attr, int attr_len, const char* val, int val_len);
    int getdbattr(uint32_t area, const char* attr, int attr_len, char** val, int* val_len);
    ...
    int removefilter(int area, char* key_pattern, int kplen, char* field_pattern, int fplen,
            char* val_pattern, int vplen);
    int verify_password(uint32_t area, const char* pwd, const int pwd_len);
    //string
