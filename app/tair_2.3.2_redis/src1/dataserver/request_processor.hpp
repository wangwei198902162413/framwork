...
#include "set_ns_attr_packet.hpp"
#include "get_ns_attr_packet.hpp"
#include "simple_return_packet.hpp"
...
namespace tair {
   ...
   public:
      ...
      int process (request_set_ns_attr * request, bool & send_return);
      int process (request_get_ns_attr * request, bool & send_return);
