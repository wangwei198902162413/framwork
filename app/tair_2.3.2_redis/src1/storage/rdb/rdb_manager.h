...
public:
    ...
    int lazyclear(int area, const char* password, const int len);

    int dumparea(int area);

    int loadarea(int area);

    int setnsattr(int bucket_number, const char* attr, const int attr_len,
            const char* val, const int val_len, const char* password, const int len);

    int getnsattr(int bucket_number, const char* attr, const int attr_len,
